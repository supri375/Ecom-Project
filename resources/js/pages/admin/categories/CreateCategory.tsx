...
const CreateCategory = () => {
    ...
    function handleSubmit(e: React.ChangeEvent<HTMLFormElement>) {
        ...
        router.post(route('categories.store'), fd), {
                    ...
                    <div className="max-w-5xl mx-auto p-6">
                        ...
                        <div className="w-full mx-auto flex items-center justify-center p-10 rounded-[20px] shadow-xl border-[0.1px]">
                            <form id="formid" onSubmit={handleSubmit} className="flex flex-col w-full gap-[10px]">
                                ...
                                <button className="mx-auto bg-blue-600 rounded-[10px] text-[14px] ml-0 h-[40px] w-[30%] text-white my-2 cursor-pointer active:bg-blue-400 hover:bg-blue-500 ">Add Category</button>
